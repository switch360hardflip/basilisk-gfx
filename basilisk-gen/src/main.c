...
#define BSGEN_OUTPUT_PATH_INCLUDE "../../../basilisk-core/include/"
#define BSGEN_OUTPUT_PATH_SOURCE "../../../basilisk-core/src/"
...
static void bsgen_readFunction(xmlNode* node, int original_function_id, bsgen_Function* out, char variadic) {
    ...
    xmlNode* body_value = bsgen_getSingleChild(node, "body");
    ...
    out->body = body_value ? body_value->children->content : NULL;
...
// 				<param><type>bs_v<xsl:value-of select="/"/></type><name>a</name></param>
...
static bsgen_String* bsgen_generateTrampoline(
    bsgen_String* string, 
    bsgen_Library* library, 
    const char* file_name, 
    const char* table_structure_name, 
...
#define BSGEN_STRUCT_START "struct {" BSGEN_NEWLINE
    ...
    string = bsgen_appendStringF(string, "};" BSGEN_NEWLINE BSGEN_NEWLINE "%s %s = { 0 };" BSGEN_NEWLINE BSGEN_NEWLINE, table_structure_name, table_name);
    ...
    */
    for (int i = 0; i < library->functions.count; i++) {
        ...
        if (function->body)
            string = bsgen_appendString(string, function->body, strlen(function->body));
        else {
  ...
  /*==============================================================================
   * Trampoline Table Generation
   *============================================================================*/

static bsgen_String* bsgen_generateTrampolineTable(bsgen_String* string, bsgen_Library* library, const char* file_name, const char* function_name, const char* output_path) {
    string = bsgen_appendStringF(string, "void %s() {", function_name);

    for (int i = 0; i < library->functions.count; i++) {
        bsgen_Function* function = bsgen_fetchUnit(&library->functions, i);
        string = bsgen_appendStringF(string, BSGEN_NEWLINE BSGEN_INDENT "%s", function_name);
    }
...
int main(int argc, const char* argv[]) {
    ...
    string = bsgen_generateHeader(string, &basilisk_core, "basilisk.h", "BASILISK_H", "BSAPI", BSGEN_OUTPUT_PATH_INCLUDE);

    string = bsgen_string(string, "", 0);
    string = bsgen_appendLicense(string, license_indented);
    string = bsgen_generateHeader(string, &basilisk_core_internal, "bs_internal.h", "BS_INTERNAL_H", "", BSGEN_OUTPUT_PATH_INCLUDE);

    string = bsgen_string(string, "", 0);
    string = bsgen_appendLicense(string, license_indented);
    string = bsgen_appendStringF(string, "#include \"./basilisk.h\"" BSGEN_NEWLINE BSGEN_NEWLINE);
    string = bsgen_generateTrampoline(string, &basilisk_core, "bs_validation.c", "bs_Functions", "_bs_functions", BSGEN_OUTPUT_PATH_SOURCE);

    string = bsgen_string(string, "", 0);
    string = bsgen_appendLicense(string, license_indented);
    string = bsgen_appendStringF(string, "#include \"./basilisk.h\"" BSGEN_NEWLINE BSGEN_NEWLINE);
    string = bsgen_generateTrampolineTable(string, &basilisk_core, "bs_trampoline.c", "bs_iniFunctionTable", BSGEN_OUTPUT_PATH_SOURCE);
